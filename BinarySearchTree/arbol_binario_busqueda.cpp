...
public:
	...
	arbol_binario_busqueda(int data) 
	{
		...
		raiz->color = negro;
		cout << "Se ha creado un arbol binario con raiz " << " " << raiz->data << endl;
	}
...
int main() {
	arbol_binario_busqueda  raiz_cabeza(50);
	raiz_cabeza.insertar(30);
	raiz_cabeza.insertar(60);
	raiz_cabeza.insertar(40);
	raiz_cabeza.insertar(10);
	raiz_cabeza.insertar(9);
	raiz_cabeza.insertar(15);
	raiz_cabeza.insertar(14);
	
	raiz_cabeza.borrar(30);
	raiz_cabeza.insertar(11);
	
	
	raiz_cabeza.inorder(raiz_cabeza.raiz);
